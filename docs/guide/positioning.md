...
| Committed, resumable SSE change feed (SUPA-5)                                               | **Planned**                                          | Named roadmap: [SUPA-5-realtime.md](../specs/SUPA-5-realtime.md) — future tense only: “planned committed SSE change feed”                                                                                                          |
...
> capability has been released — which is why SUPA-3/5/6 stay under **Planned**
> here and DB-SUPA-4 stays at **implemented on branch, release evidence
> pending**. Statuses change only through the review rule below, never by
> assumption.
