...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  ...
                  → checks /Users/lexykwaii/Code/duckbrain/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/lexykwaii/Code/duckbrain/.opencode/get-shit-done
                  → writes to /Users/lexykwaii/Code/duckbrain/.opencode/get-shit-done/hooks/
...
```bash
INIT=$(node "/Users/lexykwaii/Code/duckbrain/.opencode/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/lexykwaii/Code/duckbrain/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/lexykwaii/Code/duckbrain/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
