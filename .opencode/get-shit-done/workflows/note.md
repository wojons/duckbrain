...
- **Global scope**: `/Users/lexykwaii/Code/duckbrain/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/lexykwaii/Code/duckbrain/.opencode/notes/`)
...
2. Glob `/Users/lexykwaii/Code/duckbrain/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/Users/lexykwaii/Code/duckbrain/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/lexykwaii/Code/duckbrain/.opencode/notes/` — works in any directory
