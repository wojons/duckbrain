...
export function isValidMemoryResponse(data: unknown): data is MemoryResponse {
  ...
  if (
    memory.attributes !== undefined &&
    typeof memory.attributes !== "object"
  ) {
    return false;
  }
 ...
 */
export function isValidNamespaceResponse(
  data: unknown,
): data is NamespaceResponse {
  if (!data || typeof data !== "object") return false;
 ...
 */
export function isValidMemoryListResponse(
  data: unknown,
): data is MemoryListResponse {
  if (!data || typeof data !== "object") return false;
 ...
 */
export function isValidNamespaceListResponse(
  data: unknown,
): data is NamespaceListResponse {
  if (!data || typeof data !== "object") return false;
 ...
 */
export function validateMemoryResponse(
  data: unknown,
): ValidationResult<MemoryResponse> {
 ...
 * Validate data with detailed error message
 */
export function validateMemoryListResponse(
  data: unknown,
): ValidationResult<MemoryListResponse> {
 ...
 * Validate data with detailed error message
 */
export function validateKeyTreeResponse(
  data: unknown,
): ValidationResult<KeyTreeResponse> {
 ...
 * Validate data with detailed error message
 */
export function validateNamespaceListResponse(
  data: unknown,
): ValidationResult<NamespaceListResponse> {
  ...
  return {
    valid: false,
    error:
      "Invalid NamespaceListResponse: malformed namespaces list from server",
  };
}
